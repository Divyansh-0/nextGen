...
const AddJob = ({ onButtonClick, job, jobID }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      job(response.data.data.jobId);
      console.log("Job ID:", addJob);
    } catch (err) {
      console.log(err);
    }
  ...
  return (
    <div className="addjob-cont">
      <form onSubmit={handleSubmit} className="add-job">
        ...
        <button type="submit" className="add-job-but" onClick={handleSubmit}>
          Submit
        </button>
      </form>
    </div>
